---
name: impeccable
description: 'Explicit-only frontend design and polish workflow. Invoke with `$impeccable` for design, redesign, critique, audit, UX, accessibility, performance, responsive behavior, visual systems, typography, layout, color, motion, copy, edge cases, i18n, or browser iteration on frontend interfaces. Do not auto-trigger from ordinary frontend work.'
