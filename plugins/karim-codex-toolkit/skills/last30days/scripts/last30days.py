...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--web-backend", default="auto",
                        choices=["auto", "brave", "serper", "parallel", "none"],
                        help="Web search backend (default: auto, tries Brave then Serper then Parallel)")
            ...
            if comp_explicit:
                ...
                if not resolve_mod._has_backend(config) and not args.mock:
                    sys.stderr.write(
                        ...
                        "BRAVE_API_KEY / SERPER_API_KEY / PARALLEL_API_KEY / "
