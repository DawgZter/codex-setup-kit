...
description: 'Route all Remotion work through one skill. Use for creating or configuring Remotion projects and compositions; writing Remotion React markup; captions; maps; multimedia inspection or editing; Studio interactivity; rendering; Remotion-powered SaaS or automation; current Remotion API documentation; and Remotion or Mediabunny upgrades.'
metadata:
  version: 4.0.506
---
